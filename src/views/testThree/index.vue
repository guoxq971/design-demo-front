<template>
  <div style="background-color:#f2f2f2;width: 100vw;height: 100vh;display: flex;justify-content: center">
    <div>
...
const activePath = ref(list.value.at(-1).value);
const activeLight = ref(lightList.value[2].value);
